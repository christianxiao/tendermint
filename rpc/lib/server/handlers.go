...
import (
	...
	types "github.com/christianxiao/tendermint/rpc/lib/types"
...
// If some writes don't set it while others do, they may timeout incorrectly (https://github.com/christianxiao/tendermint/issues/553)
