...
See the [open issues](https://github.com/christianxiao/tendermint/issues) for things we need help with!
...
`$GOPATH/src/github.com/christianxiao/tendermint`, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

- Create the fork on github, using the fork button.
- Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/christianxiao/tendermint`)
...
- create a development branch either on github.com/christianxiao/tendermint, or your fork (using `git remote add origin`)
