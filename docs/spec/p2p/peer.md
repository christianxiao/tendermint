...
For details on peer discovery, see the [peer exchange (PEX) reactor doc](https://github.com/christianxiao/tendermint/blob/master/docs/spec/reactors/pex/pex.md).
