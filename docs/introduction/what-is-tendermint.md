...
(ABCI)](https://github.com/christianxiao/tendermint/tree/master/abci)
...
[Tendermint Core](https://github.com/christianxiao/tendermint) (the
...
Types](https://github.com/christianxiao/tendermint/blob/master/abci/README.md#message-types).
