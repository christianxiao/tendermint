...
[here](https://github.com/christianxiao/tendermint/wiki/Setting-GOPATH) for
more info.

Then run

```
go get github.com/christianxiao/tendermint
...
human-readable](https://github.com/christianxiao/tendermint/issues/1794).
